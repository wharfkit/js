...
export class Action extends Struct {
    ...
    @Struct.field(UInt64, {optional: true}) declare cpu_usage_us: UInt64
    @Struct.field(UInt64, {optional: true}) declare net_usage_words: UInt64
    @Struct.field(UInt64, {optional: true}) declare parent: UInt64
    @Struct.field('string', {array: true, optional: true}) declare signatures: string[]
}
...
export class GetCreatorResponse extends Struct {
    @Struct.field(Float64) declare query_time_ms: Float64
    @Struct.field(Name) declare account: Name
    @Struct.field(Name) declare creator: Name // In the case of eosio account this can be string "__self__"
    @Struct.field(BlockTimestamp) declare timestamp: BlockTimestamp
    @Struct.field(UInt32) declare block_num: UInt32
    @Struct.field(Checksum256) declare trx_id: Checksum256 // In the case of eosio account this can be empty
}
