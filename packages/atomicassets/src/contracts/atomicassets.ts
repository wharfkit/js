...
export namespace ActionParams {
    ...
    export interface Logburnasset {
        ...
        old_immutable_data: Types.AtomicAttribute[]
        old_mutable_data: Types.AtomicAttribute[]
    ...
    export interface Logmint {
        ...
        backed_tokens: AssetType[]
        immutable_template_data: Types.AtomicAttribute[]
    }
    ...
    export interface Logsetdata {
        asset_owner: NameType
        asset_id: UInt64Type
        old_data: Types.AtomicAttribute[]
        new_data: Types.AtomicAttribute[]
    }
    ...
    export interface Setassetdata {
        ...
        asset_owner: NameType
        asset_id: UInt64Type
        new_mutable_data: Types.AtomicAttribute[]
    }
...
export namespace Types {
    ...
    class AtomicVariant extends Variant {
        declare value:
            | Int8
            | Int16
            | Int32
    ...
    @Struct.type('atomic_attribute')
    export class AtomicAttribute extends Struct {
        @Struct.field('string')
        key!: string
        @Struct.field(AtomicVariant)
        value!: AtomicVariant
    }
    ...
    export class Logburnasset extends Struct {
        ...
        backed_tokens!: Asset[]
        @Struct.field(AtomicAttribute, {array: true})
        old_immutable_data!: AtomicAttribute[]
        @Struct.field(AtomicAttribute, {array: true})
        old_mutable_data!: AtomicAttribute[]
        @Struct.field(Name)
    ...
    export class Logmint extends Struct {
        ...
        backed_tokens!: Asset[]
        @Struct.field(AtomicAttribute, {array: true})
        immutable_template_data!: AtomicAttribute[]
    }
    ...
    export class Logsetdata extends Struct {
        ...
        asset_id!: UInt64
        @Struct.field(AtomicAttribute, {array: true})
        old_data!: AtomicAttribute[]
        @Struct.field(AtomicAttribute, {array: true})
        new_data!: AtomicAttribute[]
    }
